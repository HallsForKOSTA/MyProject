		...
		<div class="row">
			...
			<div class="col-sm-12 col-lg-12">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
							 ...
							 -->
							<form action="tradeOn.do?playerId=${player.playerId}"
								method="post">
										...
										<c:forEach items="${base.players}" var="play" varStatus="st">
											<tr>
												<td class="text-center"><input type="radio"
													name="targetPlayer" value="${play.playerId }"></td>
												...
												<td class="text-center">${base.name}</td>
											</tr>
										</c:forEach>
									</tr>
								</c:forEach>
				...
				<div class="text-right">
					<%-- 					<a href="tradeOn.do?playerId=${player.playerId}"> --%>
